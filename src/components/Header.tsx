        ...
        <nav className="hidden items-center gap-5 lg:flex">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
              className="relative text-xs md:text-sm font-semibold uppercase tracking-wide text-aps-navy transition-all duration-300 hover:text-aps-magenta"
            >
              {link.label}
          ...
          <Link
            href="/login"
            className="group relative overflow-hidden rounded-xl bg-gradient-to-r from-aps-navy to-aps-magenta px-4 py-2.5 text-xs md:text-sm font-semibold text-white transition-all duration-300 hover:shadow-[0_0_30px_rgba(27,42,107,0.4)] hover:scale-105"
          >
          ...
          <div className="flex flex-col gap-2.5">
            {navLinks.map((link, idx) => (
              <Link
                ...
                className="animate-in slide-in-from-right text-sm font-semibold uppercase tracking-wide text-white transition-all duration-300 hover:text-aps-gold"
            ...
            <Link
              href="/login"
              onClick={() => setMenuOpen(false)}
              className="mt-2 animate-in slide-in-from-right rounded-xl bg-aps-gold px-6 py-2.5 text-center text-sm font-semibold text-aps-navy transition-all duration-300 hover:scale-105"
